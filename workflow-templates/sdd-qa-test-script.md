...
category: Workflow
tags: [workflow, testing, playwright, jest, phpunit, xunit, nunit, junit, pytest, gotest, e2e, unit, automation]
---
...
7. Run Go: `go test -v ./tests/...`
8. Generate QA report: `sdd-gen /qa-report <featureName>`
