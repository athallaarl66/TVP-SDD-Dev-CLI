...
`,
    // Go (testing)
    gotest: `// Auto-generated from ${featureName}-SPEC_TEST.md
...
func Test${featureName.charAt(0).toUpperCase() + featureName.slice(1).replace(/-([a-z])/g, (g) => g[1].toUpperCase())}(t *testing.T) {
	// TODO: Implement test based on SPEC_TEST requirements
	if !true {
