...
const { AI_SUBDIRS, checkAndMigrateWindsurf } = require('../ai-tools');
...
`));
        ...
        setupSpinner.succeed(`Folder structure ready for: ${selectedTools.join(', ')}`);
        ...
        console.log(chalk.bold.cyan(`\nInstalling templates, skills, and workflows...\n`));
        ...
        if (selectedTools.length > 0) {
          ...
          console.log(chalk.gray(`  - ${selectedTools[0]}/skills/    (PRD, Technical Design)`));
          console.log(chalk.gray(`  - ${selectedTools[0]}/workflows/ (Spec Test, QA Report)\n`));
        }
